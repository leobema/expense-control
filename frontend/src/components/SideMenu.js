      ...
      <div className="px-4 py-6">
        <nav aria-label="Main Nav" className="mt-6 flex flex-col space-y-1">
          ...
          >
            ...
            />
            <span className="text-sm font-medium">Control Compras</span>
          </Link>
            ...
            <summary className="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
              <Link to="/#">
                <div className="flex items-center gap-2">
                  <img
                    alt="inventory-icon-mp"
                    src={require("../assets/calculadora-icon.png")}
                  />
                  <span className="text-sm font-medium"> Calculadora de Costos </span>
                </div>
              </Link>
            </summary>
          </details>
            ...
            <summary className="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
              <Link to="/#">
                <div className="flex items-center gap-2">
                  <img
                    alt="inventory-icon-mp"
                    src={require("../assets/presup-icon.png")}
                  />
            ...
            <summary className="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
              <Link to="/inventory">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-sm font-medium"> Inventario Productos </span>
                </div>
              </Link>
            </summary>
          </details>
            ...
            <summary className="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
              <Link to="/manage-store">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-sm font-medium"> Puntos de Ventas </span>
                </div>
              </Link>
            </summary>
          </details> */}
