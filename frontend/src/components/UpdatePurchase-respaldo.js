...
export default function UpdatePurchase({
 ...
 // const { _id, ProductID, description, stock, totalPurchaseAmount } = updatePurchaseData;
/*   const [purchase, setPurchase] = useState({
    purchaseID: _id,
    productID: ProductID?.name,
    design: ProductID?.designs.name,
  ...
  useEffect(() => {
    const { _id, name, designs, description, price } = updatePurchaseData;
